...
public class CancelationRequest implements IRequestor {
    ...
    public IResponse sendRequest(IRequest request) throws GeneralException, AuthException, IOException {
        ...
        try {
        	...
        	httppost.setHeader(new BasicHeader("Authorization", "bearer " + request.Token));//set First Header
        	httppost.addHeader(new BasicHeader("Content-Type", "application/json"));//other header
